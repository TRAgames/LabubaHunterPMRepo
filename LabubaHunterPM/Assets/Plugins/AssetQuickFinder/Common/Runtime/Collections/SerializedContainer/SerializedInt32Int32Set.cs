...
{
    public class SerializedInt32Int32Set : ISerializedSet<kint>
    {
        public const int KEY_SIZE = sizeof(kint);
        public const int HEAD_SIZE = KEY_SIZE * 3 + 4;
        public const int SLOT_SIZE = KEY_SIZE * 2 + 1;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Find(kint key)
        {
            return Find(key, out _);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Find(kint key, out kint location)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Add(kint key)
        {
            var slots = GetSpan();
            if (Find(key, out var islot))
            {
                return true;
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public KeyEnumerator EveryKey()
        {
            return new KeyEnumerator(GetSpan());
        }
        ...
        public ref struct KeyEnumerator
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public KeyEnumerator(Span<Slot> container)
            {
        ...
        public struct Slot
        {
            ...
            [FieldOffset(KEY_SIZE)] public kint prev;

            [FieldOffset(KEY_SIZE * 2)] public byte flag;
